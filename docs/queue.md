...
## For Users
The Queue module allows administrators to monitor and manage background jobs within the Smart Messenger application.

### What you can do:
- View all active queues and their statistics
- Start and stop workers for a queue
- Start and stop the scheduler
- Retry or delete failed jobs
- Monitor scheduler status and uptime
